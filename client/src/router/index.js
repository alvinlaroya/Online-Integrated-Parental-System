...
import GuardianDashboard from "@/views/navigation/GuardianDashboard.vue";
import Subject from "@/views/navigation/Subject.vue";
import UserManagement from "@/views/navigation/UserManagement.vue";
import Grade from "@/views/navigation/Grade.vue";
import ShowGrade from "@/components/navigation/ShowGrade.vue";

// Forms
import AddStudent from "@/components/navigation/AddStudent.vue";
import AddGrade from "@/components/navigation/AddGrade.vue";
...
const routes = [
  ...
  },
  {
    ...
    name: "navigation.guardian.dashboard",
    components: {
      default: GuardianDashboard,
      navbar: Navbar,
      sidebar: Sidebar,
    },
    beforeEnter(to, from, next) {
